...
- **Virtual destructor**: occupies **two** adjacent vtable slots in Itanium — the *complete-object/deleting destructor* (D0) and the *base-object destructor* (D1/D2 family: D1 complete, D2 base). Deleting through a base pointer without a virtual destructor is UB. Adding a virtual destructor adds a vptr (8 bytes) and breaks triviality/standard-layout.
