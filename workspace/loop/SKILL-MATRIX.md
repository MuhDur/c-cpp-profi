...
|---:|---|---|---|
| ✓ | operationalizing-expertise | C6,C4 | **APPLIED (iter 6)** — UNKNOWN-DOMAIN.md derivation recipe + 4 new seed packs (11 total) + cpp_domain_detect.sh + worked example. C6 12→16. (iter-1 wiring also used this lens.) |
